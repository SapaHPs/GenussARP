...
<a href="index.php?action=atun" class="app-link">
    <div class="app-card" data-categoria="Carnes" data-propiedad="Proteinas">
        <img src="img/atun.png" alt="Atún" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=trucha" class="app-link">
    <div class="app-card" data-categoria="Carnes" data-propiedad="Proteinas">
        <img src="img/trucha.png" alt="Trucha" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=sardinas" class="app-link">
    <div class="app-card" data-categoria="Carnes" data-propiedad="Proteinas">
        <img src="img/sardinas.png" alt="Sardinas" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=pavo" class="app-link">
    <div class="app-card" data-categoria="Carnes" data-propiedad="Proteinas">
        <img src="img/pavo.png" alt="Pavo" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=cerdo" class="app-link">
    <div class="app-card" data-categoria="Carnes" data-propiedad="Proteinas">
        <img src="img/carne_cerdo.png" alt="Carne de Cerdo" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=cordero" class="app-link">
    <div class="app-card" data-categoria="Carnes" data-propiedad="Proteinas">
        <img src="img/cordero.png" alt="Cordero" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=nueces" class="app-link">
    <div class="app-card" data-categoria="Semillas" data-propiedad="Grasas">
        <img src="img/nueces.png" alt="Nueces" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=avellanas" class="app-link">
    <div class="app-card" data-categoria="Semillas" data-propiedad="Grasas">
        <img src="img/avellanas.png" alt="Avellanas" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=leche" class="app-link">
    <div class="app-card" data-categoria="Lacteos" data-propiedad="Calcio">
        <img src="img/leche.png" alt="Leche" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=Cleche" class="app-link">
    <div class="app-card" data-categoria="Lacteos" data-propiedad="Grasas">
        <img src="img/crema_leche.png" alt="Crema de Leche" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=helado" class="app-link">
    <div class="app-card" data-categoria="Lacteos" data-propiedad="Calcio">
        <img src="img/helado.png" alt="Helado" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=costeno" class="app-link">
    <div class="app-card" data-categoria="Lcteos" data-propiedad="Proteinas">
        <img src="img/suero_costeno.png" alt="Suero Costeño" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=scalabaza" class="app-link">
    <div class="app-card" data-categoria="Semillas" data-propiedad="Grasas">
        <img src="img/semillas_calabaza.png" alt="Semillas de Calabaza" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=sgirasol" class="app-link">
    <div class="app-card" data-categoria="Semillas" data-propiedad="Grasas">
        <img src="img/semillas_girasol.png" alt="Semillas de Girasol" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=habas" class="app-link">
    <div class="app-card" data-categoria="Legumbres" data-propiedad="Proteinas">
        <img src="img/habas.png" alt="Habas" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=repollo" class="app-link">
    <div class="app-card" data-categoria="Vegetales" data-propiedad="Vitaminas">
        <img src="img/repollo.png" alt="Repollo" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=oliva" class="app-link">
    <div class="app-card" data-categoria="Grasas" data-propiedad="Grasas">
        <img src="img/aceite_oliva.png" alt="Aceite de Oliva" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=salchichas" class="app-link">
    <div class="app-card" data-categoria="Carnes" data-propiedad="Proteinas">
        <img src="img/salchichas.png" alt="Salchichas" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=chorizo" class="app-link">
    <div class="app-card" data-categoria="Carnes" data-propiedad="Proteinas">
        <img src="img/chorizo.png" alt="Chorizo" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=yogurGriego" class="app-link">
    <div class="app-card" data-categoria="Lacteos" data-propiedad="Proteinas">
        <img src="img/yogur_griego.png" alt="Yogur Griego" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=lecheCoco" class="app-link">
    <div class="app-card" data-categoria="Lacteos" data-propiedad="Grasas">
        <img src="img/leche_coco.png" alt="Leche de Coco" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=cremaagria" class="app-link">
    <div class="app-card" data-categoria="Lacteos" data-propiedad="Grasas">
        <img src="img/crema_agria.png" alt="Crema Agria" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=ricotta" class="app-link">
    <div class="app-card" data-categoria="Lacteos" data-propiedad="Proteinas">
        <img src="img/queso_ricotta.png" alt="Queso Ricotta" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=feta" class="app-link">
    <div class="app-card" data-categoria="Lacteos" data-propiedad="Proteinas">
        <img src="img/queso_feta.png" alt="Queso Feta" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=rambutan" class="app-link">
    <div class="app-card" data-categoria="Frutas" data-propiedad="Vitaminas">
        <img src="img/rambutan.png" alt="Rambután" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=peragua" class="app-link">
    <div class="app-card" data-categoria="Frutas" data-propiedad="Vitaminas">
        <img src="img/pera_agua.png" alt="Pera de Agua" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=perejil" class="app-link">
    <div class="app-card" data-categoria="Vegetales" data-propiedad="Vitaminas">
        <img src="img/perejil.png" alt="Perejil" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=cilantro" class="app-link">
    <div class="app-card" data-categoria="Vegetales" data-propiedad="Vitaminas">
        <img src="img/cilantro.png" alt="Cilantro" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=puerro" class="app-link">
    <div class="app-card" data-categoria="Vegetales" data-propiedad="Vitaminas">
        <img src="img/cebolla_puerro.png" alt="Cebolla Puerro" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=soja" class="app-link">
    <div class="app-card" data-categoria="Legumbres" data-propiedad="Proteinas">
        <img src="img/soja.png" alt="Soya" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=arroz" class="app-link">
    <div class="app-card" data-categoria="Cereales" data-propiedad="Carbohidratos">
        <img src="img/arroz.png" alt="Arroz" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=granola" class="app-link">
    <div class="app-card" data-categoria="Cereales" data-propiedad="Carbohidratos">
        <img src="img/granola.png" alt="Granola" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=pasta" class="app-link">
    <div class="app-card" data-categoria="Cereales" data-propiedad="Carbohidratos">
        <img src="img/pasta.png" alt="Pasta" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=papa" class="app-link">
    <div class="app-card" data-categoria="Tuberculos" data-propiedad="Carbohidratos">
        <img src="img/papa.png" alt="Papa" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=calabaza" class="app-link">
    <div class="app-card" data-categoria="Vegetales" data-propiedad="Vitaminas">
        <img src="img/calabaza.png" alt="Calabaza" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=Ahuyama" class="app-link">
    <div class="app-card" data-categoria="Vegetales" data-propiedad="Vitaminas">
        <img src="img/Ahuyama.png" alt="Ahuyama" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=granadilla" class="app-link">
    <div class="app-card" data-categoria="Frutas" data-propiedad="Vitaminas">
        <img src="img/granadilla.png" alt="Granadilla" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
...
<a href="index.php?action=cereza" class="app-link">
    <div class="app-card" data-categoria="Frutas" data-propiedad="Vitaminas">
        <img src="img/cereza.png" alt="Cereza" class="app-icon" style="background-color: #ffab73;">
        <div class="app-text">
